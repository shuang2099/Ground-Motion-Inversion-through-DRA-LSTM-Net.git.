...
X_train = load_mat_file('X_train.mat')
X_val = load_mat_file('X_vali.mat')
X_test = load_mat_file('X_test_2.mat')

# Load target vectors
y_train = load_mat_file('y_train.mat')
y_val = load_mat_file('y_vali.mat')
y_test = load_mat_file('y_test_2.mat')
...
# Calculate Maximum Absolute Error for test data
maxae = np.max(np.abs(y_test.flatten() - y_test_pred))
print('Maximum Absolute Error (MaxAE) on Test Dataset:', maxae)

# Calculate MSE for test data
mse = mean_squared_error(y_test.flatten(), y_test_pred)
print('Mean Square Error (MSE) on Test Dataset:', mse)
